...
If you prefer direct support, choose the method that is easiest for you. These options are intentionally kept here instead of in the README, so the project homepage stays focused on the plugin.

如果你更喜欢直接支持，可以选择最方便的方式。二维码保留在这个独立页面中，README 只展示项目本身。

| PayPal | WeChat Pay | Alipay |
|:---:|:---:|:---:|
| <img src="docs/donate/paypal.jpg" width="170" alt="PayPal QR"/> | <img src="docs/donate/wechat.jpg" width="170" alt="WeChat Pay QR"/> | <img src="docs/donate/alipay.jpg" width="170" alt="Alipay QR"/> |
...
Thank you for every star, issue report, translation fix, and cup of coffee.

感谢每一个 Star、问题反馈、翻译修正，以及每一杯咖啡。
